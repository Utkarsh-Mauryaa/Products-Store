    ...
    <div className={`text-center h-screen dark:text-sky-500`}>
      ...
      <Link to='/' className={`${notify ? "pointer-events-none" : "pointer-events-auto"} ${success ? "pointer-events-none" : "pointer-events-auto"}`}>
        <button onClick={() => {
          ...
          className={`m-13 border-1 p-4 bg-cyan-200 cursor-pointer hover:drop-shadow-[0_0_15px_#00E3E3] transition duration-300 rounded-[10px] dark:text-sky-500 dark:bg-slate-900 ${notify ? "pointer-events-none" : "pointer-events-auto"} ${success ? "pointer-events-none" : "pointer-events-auto"}`}>Log Out</button>
      </Link>
      <Link to='/home' className={`${notify ? "pointer-events-none" : "pointer-events-auto"} ${success ? "pointer-events-none" : "pointer-events-auto"}`}>
        <button onClick={() => {
          setAddIcon(!addIcon);
        }}
          className={`m-13 border-1 p-4 bg-cyan-200 cursor-pointer hover:drop-shadow-[0_0_15px_#00E3E3] transition duration-300 rounded-[10px] dark:text-sky-500 dark:bg-slate-900 ${notify ? "pointer-events-none" : "pointer-events-auto"} ${success ? "pointer-events-none" : "pointer-events-auto"}`}>Show My Products</button>
      </Link>
